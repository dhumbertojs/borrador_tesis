...
inp <- "/home/dhjs/Documentos/R_projects/electoral_accountability/regression/alternative"
list.files(inp)
out <- "/home/dhjs/Documentos/R_projects/electoral_accountability/regression/alternative/tables"
